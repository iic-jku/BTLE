...
BTLE is a free and open-source Bluetooth Low Energy (BLE) Software Defined Radio software suite and [open BTLE chip design](https://github.com/JiaoXianjun/BTLE/tree/master/open_btle_baseband_chip). 

It includes:
  * BTLE baseband [algorithms description, Python and Verilog implementation, FPGA and SkyWater 130 PDK (OpenLane2 workflow) results](https://github.com/JiaoXianjun/BTLE/tree/master/open_btle_baseband_chip).
  * Analog Devices AD9361 + Xilinx Zynq FPGA implementation: [FPGA Bluetooth](https://github.com/JiaoXianjun/BTLE/tree/fpga_dev/fpga)
